%% getIndivLikelihood_ABTGrGp_Combined
% This is a model with one combined learner, and differentiated gammas

%% Params
% x should be [alpha beta temp gammaR gammaP]

function [likelihood, numSlips] = getIndivLikelihood_ABTGrGp_Combined(x, A1, S2, A2, Re)
