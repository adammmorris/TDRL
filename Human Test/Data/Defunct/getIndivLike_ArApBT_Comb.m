%% getIndivLike_ArApBT_Comb
% This is a model with a combined learner, and differentiated alphas

%% Params
% x should be [alphaR alphaP beta temp]

function [likelihood, numSlips] = getIndivLike_ArApBT_Comb(x, A1, S2, A2, Re)
