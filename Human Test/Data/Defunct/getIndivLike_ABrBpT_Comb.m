...
% This is a model with a combined learner, and differentiated betas

%% Params
% x should be [alpha betaR betaP temp]

function [likelihood, numSlips] = getIndivLike_ABrBpT_Comb(x, A1, S2, A2, Re)
