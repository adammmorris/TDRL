%% getIndivLikelihood_ABTGrGp
% This is a model with differentiated gammas, and everything else
%   undifferentiated

%% Params
% x should be [alpha beta temp gammaR gammaP]

function [likelihood, numSlips] = getIndivLikelihood_ABTGrGp(x, A1, S2, A2, Re)
