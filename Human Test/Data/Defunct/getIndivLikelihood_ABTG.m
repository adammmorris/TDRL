%% getIndivLikelihood_ABTG
% This is a model that includes undifferentiated gammas (everything else is
%   undifferentiated also)

%% Params
% x should be [alpha beta temp gamma]

function [likelihood, numSlips] = getIndivLikelihood_ABTG(x, A1, S2, A2, Re)
