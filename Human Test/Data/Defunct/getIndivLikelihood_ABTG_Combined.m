%% getIndivLikelihood_ABTG_Combined
% This is a model with one combined learner, and all undifferentiated
%   parameters (including gamma)

%% Params
% x should be [alpha beta temp gamma]

function [likelihood, numSlips] = getIndivLikelihood_ABTG_Combined(x, A1, S2, A2, Re)
