...
% Note that right now, only using those 4 inputs - to reduce the parameter
%   space over which to optimize.

function [totEarnings, stdEarnings, learnCurve] = ac_sep_1p5(x, numInstances)
