...
function [res1, res2, res3] = Map_ABtemp(betas, temps, boardPath, optNum_alpha, optNum_beta, optNum_temp, saveData)
    min_param = 0;
    max_param = .9;
    param_step = .15;
    ...
    res1 = fvals_alphas_1;
    res2 = fvals_betas_1;
    res3 = Map_temp([best_alphaR best_alphaP], [.1 .1], boardPath, optNum_temp, saveData);
