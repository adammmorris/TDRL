...
for i = 1:numBoards
    ...
    elseif randomized == 2
        ...
        % level 2 - 2:5
        boards(2:4, i) = randsample(-15:-1, 3, true);
        boards(5, i) = randsample(1:15, 1, true);
        boards(2:5, i) = randsample(boards(2:5, i), length(boards(2:5, i))); % Permute
        
        % level 3 - 6:21
        boards(6:17, i) = randsample(-30:-1, 12, true);
        boards(18:21, i) = randsample(1:30, 4, true);
        boards(6:21, i) = randsample(boards(6:21, i), length(boards(6:21, i))); % Permute
        
        % level 3 - 22:85
        boards(22:69, i) = randsample(-60:-1, 48, true);
        boards(70:85, i) = randsample(1:60, 16, true);
...
save(strcat(currentPath, '/Board10_numerous.mat'), 'boards', 'transitions', 'numStates', 'numMoves', 'numActions', 'numBoards')