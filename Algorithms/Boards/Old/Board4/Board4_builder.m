% This script builds Board4
% Board4 is single-tier, punishments are doubled, more punishments than
%   rewards
...
save(strcat(currentPath, '/Board4.mat'), 'boards', 'transitions', 'numStates', 'numMoves', 'numActions', 'numBoards')