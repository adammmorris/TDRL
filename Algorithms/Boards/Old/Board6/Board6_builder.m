% This script builds Board6
% Board6 is single-tier, punishments are doubled, more punishments than
%   rewards
% Same as Board4, except there's no branch w/o a reward (one reward is
%   added in 3rd branch)
...
numBoards = 20000;  % # of separate boards to be made
...
rewards = [-50 25 -20 -10 -100 50 -20 -10 -64 -32 0 32 -10 5 -20 10]';
...
save(strcat(currentPath, '/Board6_soft.mat'), 'boards', 'transitions', 'numStates', 'numMoves', 'numActions', 'numBoards')