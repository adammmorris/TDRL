% This script builds Board3
% Board3 is single-tier, punishments are doubled, equal amounts of
%   rewards & punishments
...
rewards = [-50 25 -20 10 -100 50 -20 10 -64 32 0 0 -10 5 -20 10]';
...
save(strcat(currentPath, '/Board3_soft.mat'), 'boards', 'transitions', 'numStates', 'numMoves', 'numActions', 'numBoards')