% This script builds Board14
% Board14 is Board9 with more severe level 2 punishments
...
for i = 1:numBoards
    if randomized == 1
        ...
        boards(2:3, i) = randsample(-25:-10, 2, true);
        boards(4:5, i) = [0 0];
...
save(strcat(currentPath, '/Board14_soft.mat'), 'boards', 'transitions', 'numStates', 'numMoves', 'numActions', 'numBoards')