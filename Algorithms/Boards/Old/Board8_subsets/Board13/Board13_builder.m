% This script builds Board13
% Board13 is single-tier, punishments are doubled, more punishments than rewards - w/ multiple branches of all punishments
% (This is Board8 with doubled punishments & more punishments)
...
for i = 1:numBoards
    if randomized == 1
        ...
        % First 4 trees
        for k = 1:4
            trees(k, 1:8) = randsample(-50:-25, 8, true);
        end
...
save(strcat(currentPath, '/Board13_soft.mat'), 'boards', 'transitions', 'numStates', 'numMoves', 'numActions', 'numBoards')