% This script builds Board2
% Board2 is single-tier, punishments are NOT doubled, equal amounts of
%   rewards & punishments
...
save(strcat(currentPath, '/Board2_soft.mat'), 'boards', 'transitions', 'numStates', 'numMoves', 'numActions', 'numBoards')