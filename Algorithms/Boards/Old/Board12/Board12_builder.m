% This script builds Board12 - a board for humans
% Board12 is 2-level w/ randomized values on both levels
...
save(strcat(currentPath, '/Board12_onelevel.mat'), 'boards', 'transitions', 'numStates', 'numMoves', 'numActions', 'numBoards', 'numSwitches', 'rewardRange')